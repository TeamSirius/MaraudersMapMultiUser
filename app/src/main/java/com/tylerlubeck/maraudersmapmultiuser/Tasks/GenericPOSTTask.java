 ...
 */
public abstract class GenericPOSTTask extends AsyncTask<Void, Void, String> {
    private enum Type {
        OBJECT,
        ARRAY
    }
    ...
    private GenericPOSTTask(String _url, String username, String password) {
        this.url = _url;
     ...
     */
    public GenericPOSTTask(String _url, JSONArray _array_data, String username, String password) {
     ...
     * @param _array_data     The JSON data to POST
     */
    GenericPOSTTask(String _url, JSONObject _array_data, String username, String password) {
        this(_url, username, password);
