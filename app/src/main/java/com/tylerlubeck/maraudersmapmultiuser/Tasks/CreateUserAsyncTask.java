...
import com.tylerlubeck.maraudersmapmultiuser.Tasks.RegisterDeviceAsyncTask;
...
public class CreateUserAsyncTask extends GenericGETTask {
    ...
    public CreateUserAsyncTask(Context _context, String _url, List<BasicNameValuePair> _params) {
        super(_url, _params);
